...
(cl:defmethod cl:initialize-instance :after ((m <ObstaclePose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObstaclePose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar_based_task1-msg:<ObstaclePose> is deprecated: use lidar_based_task1-msg:ObstaclePose instead.")))
...
(cl:defmethod x-val ((m <ObstaclePose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_based_task1-msg:x-val is deprecated.  Use lidar_based_task1-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <ObstaclePose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_based_task1-msg:y-val is deprecated.  Use lidar_based_task1-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <ObstaclePose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_based_task1-msg:z-val is deprecated.  Use lidar_based_task1-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'r-val :lambda-list '(m))
(cl:defmethod r-val ((m <ObstaclePose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_based_task1-msg:r-val is deprecated.  Use lidar_based_task1-msg:r instead.")
  (r m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ObstaclePose>)))
  ...
  "lidar_based_task1/ObstaclePose")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ObstaclePose)))
  "Returns string type for a message object of type 'ObstaclePose"
  "lidar_based_task1/ObstaclePose")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ObstaclePose>)))
  ...
  "a99a9b2fb0c861a1fcea64c1942fd4cd")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ObstaclePose)))
  "Returns md5sum for a message object of type 'ObstaclePose"
  "a99a9b2fb0c861a1fcea64c1942fd4cd")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ObstaclePose>)))
  ...
  (cl:format cl:nil "Header header~%float64 x~%float64 y~%float64 z~%float64 r~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ObstaclePose)))
  "Returns full string definition for message of type 'ObstaclePose"
  (cl:format cl:nil "Header header~%float64 x~%float64 y~%float64 z~%float64 r~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
