...
(cl:defmethod cl:initialize-instance :after ((m <UsvDrive>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UsvDrive)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar_based_task1-msg:<UsvDrive> is deprecated: use lidar_based_task1-msg:UsvDrive instead.")))

(cl:ensure-generic-function 'left-val :lambda-list '(m))
(cl:defmethod left-val ((m <UsvDrive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_based_task1-msg:left-val is deprecated.  Use lidar_based_task1-msg:left instead.")
  (left m))

(cl:ensure-generic-function 'right-val :lambda-list '(m))
(cl:defmethod right-val ((m <UsvDrive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_based_task1-msg:right-val is deprecated.  Use lidar_based_task1-msg:right instead.")
  (right m))
